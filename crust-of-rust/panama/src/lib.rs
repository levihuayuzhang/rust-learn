// https://youtu.be/b4mS5UPHh20?si=ZwlwnN6q7HUqzaNn
...
//  - Asynchronous channels: Channels where send() cannot block. Unbounded.
//   - Mutex + Condvar + VecDeque
//   - Mutex + Condvar + LinkedList
//   - Atomic Linked List, linked list of T
//   - Atomic block linked list, linked list of atomic VecDeque<T>
//  - Rendezvous channels: Synchronous with cappacity = 0. Used for thread synchronization.
//  - Oneshot channels: Any capacity. In pratice, only one call to send().
